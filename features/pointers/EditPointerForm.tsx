...
import { updatePointerAction } from "./actions";

export function EditPointerForm({
  pointerId,
  fullName,
  phone,
  address,
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-1">
        <label htmlFor={`edit-name-${pointerId}`} className="text-[13px] font-semibold text-ink-label">
          Nombre completo
        </label>
        <NameField
          id={`edit-name-${pointerId}`}
          name="fullName"
          required
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor={`edit-phone-${pointerId}`} className="text-[13px] font-semibold text-ink-label">
          Teléfono
        </label>
        <PhoneField
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor={`edit-address-${pointerId}`} className="text-[13px] font-semibold text-ink-label">
          Dirección
        </label>
        <AddressField

  ...
  return (
    ...
    >
      <div className="flex flex-col gap-1">
        <label htmlFor={`edit-name-${pointerId}`} className="text-sm font-medium text-zinc-700">
          Nombre completo
        </label>
        <NameField
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor={`edit-phone-${pointerId}`} className="text-sm font-medium text-zinc-700">
          Teléfono
        </label>
        <PhoneField
